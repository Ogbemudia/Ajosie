        ...
        jQuery.get("../../api/read_articlebyId.php?id=" + id, function(messages) {
            jQuery.each(messages, function(i, message) {
                ...
                jQuery.each(authors2, function(key, val) {
                    ...
                    authorz += `<div class="tg-borderheading"><span><span class="lnr lnr-user" style="display: inline-block;"></span> <a href="author/` + AuthorId + `/` + AuthorName + `" class="myLink">` + AuthorName + `</a></span></div>`;
                })
                aboutAuthors += `</div>`;
                ...
                var download22 = ` <div class="tg-commenter">
                            <div tg-commenterbox">
                ...
                jQuery(document).on('click', '.downloadArticle', function() {
                    ...
                    window.open("http://ajosie.edu//upload/" + downloadArt);
                    ...
                    data.forEach(function(article) {
                        ...
                        if (currenTitle === article_key_words) {
                            ...
                            for (var i = 0; i < article_words.length; i++) {
                                ...
                                if (match_count >= 1) {
                                    related_articles += `<p><a href="http://ajosie.edu/articledetail/` + article.id + `/` + urlTitle + `" style="text-decoration: none; color: #333;">` + article_title + `</a></p>`
                                        //alert(article_title)
