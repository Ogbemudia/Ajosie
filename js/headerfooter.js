jQuery(document).ready(function() {
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="tg-logoarea">
            <strong class="tg-logo"><a href="index.html"><img src="images/logo.png" alt="image description"></a></strong>
            <div class="tg-addbox">
                <a href="javascript:void(0);"><img src="images/placeholder/add-01-770x90.jpg" alt="image description"></a>
            </div>
        </div>
                ...
                <div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
                    <ul>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="index.html">Authors Guidelines </a></li>
...
<div class="tg-footerbar">
            ...
            <div class="tg-postmargin">
                <article class="tg-post">
                    <!--<figure class="tg-postimg">
                        <img src="images/postimg/img-41.jpg" alt="image description">
                    ...
                    <div class="tg-postcontent">
                        <div class="tg-borderleft">
                            ...
                            <div class="tg-posttitle">
                                <h7><a href="javascript:void(0);">The publisher retains the copyright of all the articles, reviews and reports published by the jornal. Authors are allowed to cite the papers published by the journal, but they must give credits of the works cited to the author(s) of the particular paper. No article in the journal can be used for commercial purposes, concert, or exhibition without the prior-approval by the copyright holder of the journal. </a></h7>
                            </div>
                        </div>
                    </div>
                </article>
                <!--<article class="tg-post">
                    <figure class="tg-postimg">
                        <img src="images/postimg/img-42.jpg" alt="image description">
                        <a class="tg-btnview" href="#">view</a>
                    </figure>
                    <div class="tg-postcontent">
                        <div class="tg-borderleft">
                ...
                <article class="tg-post">
                    <figure class="tg-postimg">
                        <img src="images/postimg/img-43.jpg" alt="image description">
                        <a class="tg-btnview" href="#">view</a>
                    </figure>
                    <div class="tg-postcontent">
                        <div class="tg-borderleft">
                ...
                <article class="tg-post">
                    <figure class="tg-postimg">
                        <img src="images/postimg/img-44.jpg" alt="image description">
                        <a class="tg-btnview" href="#">view</a>
                    </figure>
                    <div class="tg-postcontent">
                        <div class="tg-borderleft">
    ...
    <div class="tg-widget">
        <div class="tg-addbox">
            ...
            <a href="javascript:void(0);"><img src="images/placeholder/add-02-300x250.jpg" alt="image description"></a>
